...
public class C_Exhaustive {
	//The goal of this exercise is to build a program that takes a Caesar encrypted message and
	//tries to decrypt it by trying every possible key in the key space.
